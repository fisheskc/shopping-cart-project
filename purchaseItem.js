...
export class PurchaseItem {
    ...
    static order_id = 0;
    static costPrice = 0;
    constructor(product_id, quantity, id=0, _name) {
        this._id = id;
    ...
    static defineItem(product_id, quantity, id=0, _name) {
        if(id == 0) {
           id = PurchaseItem.itemsStore.length + 1;
        }
        let newPurchaseItem = new PurchaseItem(product_id, quantity, id, _name)
